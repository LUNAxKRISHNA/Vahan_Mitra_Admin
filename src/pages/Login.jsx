      ...
      <div className="w-full max-w-md p-6 z-10 animate-fade-in">
        <div className="glass-card p-8 shadow-glass-lg relative overflow-hidden">
          ...
          <div className="text-center">
            ...
            <p className="text-navy-500 text-sm font-medium">Admin Portal</p>
          </div>
          ...
          <div className="mt-8 space-y-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center py-3.5 px-4 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-navy-800 text-sm font-semibold shadow-sm hover:shadow-md transition-all duration-200 active:scale-[0.98] disabled:opacity-75 disabled:pointer-events-none group"
            >
              {loading ? (
                ...
                <span className="flex items-center justify-center">
                  <GoogleIcon />
                  <span className="group-hover:text-navy-950 transition-colors">Continue with Google</span>
                </span>
              )}
            </button>
